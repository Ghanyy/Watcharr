...
var (
	...
	MOVIE_CLUB_NOMINATED        ActivityType = "MOVIE_CLUB_NOMINATED"
	MOVIE_CLUB_NOMINATION_REMOVED ActivityType = "MOVIE_CLUB_NOMINATION_REMOVED"
	MOVIE_CLUB_VOTED            ActivityType = "MOVIE_CLUB_VOTED"
	MOVIE_CLUB_VOTES_CLEARED    ActivityType = "MOVIE_CLUB_VOTES_CLEARED"
	MOVIE_CLUB_CYCLE_STARTED    ActivityType = "MOVIE_CLUB_CYCLE_STARTED"
	MOVIE_CLUB_PHASE_CHANGED    ActivityType = "MOVIE_CLUB_PHASE_CHANGED"
	MOVIE_CLUB_WINNER_ANNOUNCED ActivityType = "MOVIE_CLUB_WINNER_ANNOUNCED"
)
