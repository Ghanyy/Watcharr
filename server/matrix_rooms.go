...
func InviteAllUsersToNewsRoom(db *gorm.DB, newsRoom *MatrixRoom) error {
	...
	for _, matrixUser := range matrixUsers {
		...
		skipInvitation := false
		if matrixUser.AccountType == AccountTypePersonal && matrixUser.IsAutoGenerated && Config.MOVIE_CLUB.Matrix.RegistrationSecret == "" {
			skipInvitation = true
		}
